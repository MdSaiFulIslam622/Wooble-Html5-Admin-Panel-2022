    ...
    t_jQueryDatepicker.initialize = function() {
        t_jQueryDatepicker.$element.each(function() {
            ...
            data.initialize = function() {
                ...
                calendar_day = 0;
                $datepicker.trigger('jQueryDatepicker_select_year', {
                    year: calendar_year
                });
                ...
                for (var _month = 1; _month <= 12; _month++) {
                    ...
                    for (_weekday = 1; _weekday <= 7; _weekday++) {
                        ...
                        for (var i = 0; i < _days.days.length; i++) {
                            ...
                            if ((calendar_year == selected_year) && (_month == selected_month) && (_day == selected_day)) {
            ...
            var process_start_date = function() {
                $datepicker.find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day').removeClass('jQueryDatepicker__current_other').removeClass('jQueryDatepicker__current_other_diff');
                if (calendar_year == selected_start_year && calendar_month == selected_start_month) {
                    ...
                    if (selected_year == selected_start_year) {
                        if (selected_month == selected_start_month) {
                            for (var i = selected_start_day + 1; i < calendar_day; i++) {
                                $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + selected_month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day-day-' + i)[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                            }
                                ...
                                if (_month != selected_month) {
                                    if (_month == selected_start_month) {
                                        for (var i = selected_start_day + 1; i < 32; i++) {
                                            $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + _month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day-day-' + i)[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                                        }
                                    } else {
                                        for (var i = 1; i < 32; i++) {
                                            $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + _month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day-day-' + i)[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                        ...
                        if (selected_year == calendar_year) {
                            for (var m = 1; m < selected_month; m++) {
                                $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + m).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day')[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                            }
                            for (var d = 1; d < selected_day; d++) {
                                $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + selected_month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day-day-' + d)[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                            }
                        } else if (calendar_year == selected_start_year) {
                            if (calendar_month == selected_start_month) {
                                for (var d = selected_start_day + 1; d < 32; d++) {
                                    $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + calendar_month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day-day-' + d)[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                                }
                            } else if (calendar_month > selected_start_month) {
                                $datepicker.find('.jQueryDatepicker_calendar_months_month-month-' + calendar_month).find('.jQueryDatepicker_calendar_months_month_weekdays_weekday_days_day')[is_start_date_selected ? 'addClass' : 'removeClass']('jQueryDatepicker__current_other_diff');
                            }
            ...
            $datepicker.find('.jQueryDatepicker_rotationButton').on('click.jQueryDatepicker', function(event) {
                var $button = $(this);
                $datepicker.trigger('jQueryDatepicker_change_month', {
                    rotation: $button.attr('rotation')
                });
            });
        ...
        init: function(parameters) {
            ...
            $elements.each(function() {
                ...
                if (t_init.parameters.hasOwnProperty('next_button')) {
                    $element.find('.jQueryDatepicker_header_sidebutton__right .jQueryDatepicker_header_sidebutton_content').html(t_init.parameters.next_button);
                }
                if (t_init.parameters.hasOwnProperty('prev_button')) {
                    $element.find('.jQueryDatepicker_header_sidebutton__left .jQueryDatepicker_header_sidebutton_content').html(t_init.parameters.prev_button);
                }
